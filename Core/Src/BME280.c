...
{
	float pressao_referencia = 1022.8;
	...
	result->AltitudeP = 44330*(1-pow(result->Pressure/pressao_referencia,1/5.255)); 	/*Calculation of altitude parameter in meters with
													simplified atmospheric pressure formula*/
	result->AltitudeTP = ((log(result->Pressure/pressao_referencia)*(288.16)*(-8.314))/(28.97*9.81))*1000; /*Calculation of altitude parameter in
